// =========================================================================
// modes/quick.js — Implementación del modo Quick + simulador de Turno 1.
// Extraída de app-core.js (inversión del reexport): app-core conserva solo
// bootstrap/init y reexporta los nombres legados que otros módulos importan.
// =========================================================================

import { DEBUG_MODE, smartLog, flowLog, resetSmartLog } from '../utils/debug.js';
import { clearComboBestAttackCache, clearComboSpeedCache, clearDamageCache } from '../core/runtime.js';
import { getRows, getEffectivenessBadgeHtml } from '../matrix/render.js';
import { renderAll, updateIcons } from '../render/app.js';
import { fillTeamWithSpecies } from '../teams/actions.js';
import { getTranslation, formatName, escapeHtml } from '../utils/text.js';
import { hexToRgba, typeChip, effectiveness } from '../utils/types.js';
import { getBaseStatRaw, calcMonHP } from '../battle/stats.js';
...
import { fetchMoveInfo, getMoveCandidates } from '../battle/moves.js';
...
import {
  TYPE_META, TYPE_CHART, MEGA_STONES, weatherNames, SPREAD_MOVES,
  GUARANTEED_MULTI_HITS, WEATHER_LABELS, TERRAIN_LABELS, TOOL_GROUPS,
} from '../core/constants.js';
import { getFocusedTeam, getSuggestedReserves, scoreBoard, simulateTurn } from './live.js';
...
export function isProtectMove(moveName) {
  const slug = getMoveSlug(moveName);
...
export function advanceMonTurnState(mon) {
  if (!mon?.battle) return;
...
export function getActionBlockReason(mon, moveName = null) {
...
export function applyManualMoveSideEffects(attacker, defender, moveName, targetSide) {
  const slug = getMoveSlug(moveName);
...
export function initTurn1SimulatorRuntimeBindings() {
